...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><img src="plug-in/login/images/head.png" /></div>
            <div class="formLogin">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="#" title="安普达">APD</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="金融银行理财管理系统V2.0">J</a></span></div>
    </div>
    <!-- Link JScript-->
