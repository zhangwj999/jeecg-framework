...
<t:datagrid name="userList" title="用户管理" actionUrl="userController.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group">
	...
	<t:dgCol title="银行" field="TSDepart_id" query="true" replace="${departsReplace}"></t:dgCol>
	...
	<t:dgToolBar title="数据权限" icon="icon-edit" url="userController.do?datapermit" funname="update" width="850"></t:dgToolBar>
</t:datagrid>
