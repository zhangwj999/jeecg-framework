...
<t:datagrid name="departList" title="组织机构列表" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" pagination="false"
	...
	<t:dgFunOpt funname="queryUsersByDepart(id)" title="查看用户"></t:dgFunOpt>
</t:datagrid>
<div id="departListtb" style="padding: 3px; height: 25px">
<div style="float: left;"><a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('组织机构录入','departController.do?add','departList')">组织机构录入</a> <a href="#"
	class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('组织机构编辑','departController.do?update','departList')">组织机构编辑</a></div>
</div>
</div>
</div>
