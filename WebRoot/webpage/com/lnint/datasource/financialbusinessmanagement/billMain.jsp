  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="billMainController.do?save">
		...
		<tr>
			...
			<td class="value"> <input class="inputxt" id="terminalId" name="terminalId" 
					   value="${billMainPage.terminalId}" datatype="*"></td>
		</tr>
		<tr>
			...
			<td class="value"><input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="beginTime" name="beginTime" ignore="ignore"
					     value="<fmt:formatDate value='${billMainPage.beginTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"></td>
			...
			<td class="value">		      <input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="endTime" name="endTime" ignore="ignore"
					     value="<fmt:formatDate value='${billMainPage.endTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"></td>
		</tr>
		<tr>
		...
		<tbody id="add_billProduct_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left"><input name="billProductList[#index#].billNum" maxlength="100" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].puhCard" maxlength="50" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].qty" maxlength="" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].price" maxlength="" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].amt" maxlength="" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].status" maxlength="1" type="text" style="width:120px;"></td>
				  <td align="left"><input name="billProductList[#index#].note" maxlength="200" type="text" style="width:120px;"></td>
			</tr>
		 </tbody>
		</table>
 </body>