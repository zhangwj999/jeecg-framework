...
<div class="easyui-layout" fit="true">
  ...
  actionUrl="billMainController.do?datagrid&flag=000"  autoLoadData="true"  fitColumns="true" fit="true" queryMode="group" checkbox="true" idField="id" >
   ...
   <t:dgConfOpt title="开始"  url="billMainController.do?start&id={id}"  message="开始录入" />
   <t:dgConfOpt title="结束"  url="billMainController.do?end&id={id}"   message="结束录入" />
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="billMainController.do?addorupdate" funname="add" height="800" width="1000"></t:dgToolBar>
   <t:dgToolBar title="视频回放"  icon="icon-search" url="billMainController.do?review" funname="detail" height="400"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="billMainController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="billMainController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>