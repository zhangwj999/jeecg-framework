...
<div class="container-fluid"><a class="brand" href="" target="_blank">金融银行理财管理系统V2.0 &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="" title="APD">APD</a></li>
	<li style="display: inline;">&nbsp; 技术支持:<a title="APD版本" href="">APD</a></li>
</ul>
</div>
</footer>
