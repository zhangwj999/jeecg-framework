...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div style="position: absolute; top: 78px; left: 33px;"> <span style="letter-spacing: -1px;"></span></div>
		</td>
...
<div align="center" style="color: #1fa3e5; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="" title="APD版本">APD</a>  技术支持:<a href="#" title="APD版本">APD</a> </span></div>
</div>
